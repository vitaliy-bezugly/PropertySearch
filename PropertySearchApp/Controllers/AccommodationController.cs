    ...
    private List<AccommodationViewModel> PrepareData()
    {
        return new List<AccommodationViewModel>
        {
            new AccommodationViewModel
            {
                ...
                PhotoUri = "https://i.pinimg.com/originals/31/a7/bd/31a7bd737d28ab08e1be341730100f3e.jpg"
            },
            new AccommodationViewModel
            {
            ...
            new AccommodationViewModel
            {
                ...
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://beautifuldreamhomeplans.com/Beautiful-Mediterranean-Luxury-Home-Architect-Plans.jpg"
            },
            new AccommodationViewModel
            {
                ...
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://www.realestate.com.au/blog/images/1024x768-fit,progressive/2019/08/21114902/capi_89fabccddb1bb4e76ce88070ffd56381_3926fda65b7c535a9f34af1ed1945f37.jpeg"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://cdn.apartmenttherapy.info/image/upload/v1619013756/at/house%20tours/2021-04/Erin%20K/KERR-130-CLARKSON-2R-01-020577-EDIT-WEB.jpg"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://assets.your-move.co.uk/yourmove_new/property-image/rps_yom-WLN200047/image/WLN200047_03/l.jpg"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://i.ytimg.com/vi/aUHVE3nhFzk/maxresdefault.jpg"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://media.onthemarket.com/properties/12957170/1437487200/image-1-480x320.webp"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://media.onthemarket.com/properties/11857315/1422692974/image-4-480x320.jpg"
            },
            new AccommodationViewModel
            {
                ...
                LandlordEmail = "dmitriy.gera@gmail.com",
                Price = Random.Shared.Next(450, 1480),
                PhotoUri = "https://media.onthemarket.com/properties/12722845/1430849693/image-4-480x320.jpg"
            }
        };
    }
